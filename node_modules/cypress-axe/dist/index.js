...
var injectAxe = function (injectOptions) {
    ...
    cy.window({ log: false })
        ...
        if (violations.length) {
            ...
            violations.forEach(function (v) {
                ...
                Cypress.log({
                    ...
                    message: "".concat(v.id, " on ").concat(v.nodes.length, " Node").concat(v.nodes.length === 1 ? '' : 's'),
                });
            });
        }
        ...
        if (!skipFailures) {
            ...
            Cypress.log({
                ...
                message: "".concat(violations.length, " accessibility violation").concat(violations.length === 1 ? '' : 's', " ").concat(violations.length === 1 ? 'was' : 'were', " detected"),
            });
        }
    });
};
